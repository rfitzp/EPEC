...
subroutine NameListRead (IMPURITY, NEUTRAL, FREQ, STAGE2, INTP, RESTART, OLD, TSTART, TEND, DT) &
  ...
  namelist /ScanInputs/ IMPURITY, NEUTRAL, FREQ, STAGE2, INTP, RESTART, OLD, TSTART, TEND, DT
