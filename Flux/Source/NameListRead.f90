...
subroutine NameListRead (INTG, NPSI, PACK, NTHETA, NNC, NTOR, H0, ACC, ETA, DR, MMIN, MMAX, PSILIM, TIME, PSIPED) &
  ...
  namelist /FLUX_CONTROL/ INTG, NPSI, PACK, NTHETA, NNC, NTOR, H0, ACC, ETA, DR, MMIN, MMAX, PSILIM, TIME, PSIPED
