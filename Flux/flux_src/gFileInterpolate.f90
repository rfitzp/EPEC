...
! %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
! Function to read two gFiles and write interpolated gFile
! %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

subroutine gFileInterpolate () bind (c, name = 'gFileInterpolate')
  ...
  do i = 1, NRBOX
     do j = 1, NZBOX
        Psi (i, j) = Psi1 (i, j) * weight1 + Psi2 (i, j) * weight2 + Psi2 (i, j) * weight3
     end do
  end do
...
endsubroutine gFileInterpolate
