...
subroutine gFileRead () bind (c, name = 'gFileRead')
  ...
  open (unit = 100, file = 'gFile', status = 'old')
  ...
  open  (unit = 101, file = 'Stage1/R0B0.txt')
  ...
  open  (unit = 101, file = 'Stage1/Box.txt')
  write (101, '(4e17.9)') RLEFT, ZLOW, RRIGHT, ZHIGH
  close (unit = 101)

  open  (unit = 101, file = 'Stage1/Axis.txt')
  write (101, '(2e17.9)') RAXIS /R0, ZAXIS /R0
  close (unit = 101)
 
  RMAX = dble (NRBOX-1)

  open  (unit = 101, file = 'Stage1/R.txt')
  do i = 1, NRBOX
  ...
  open  (unit = 101, file = 'Stage1/Z.txt')
  do j = 1, NZBOX
  ...
  open  (unit = 101, file = 'Stage1/Psi.txt')
  do i = 1, NRBOX
        write (101, '(1000e17.9)') (PSI (i, j) /R0/R0/B0, j = 1, NZBOX)
  enddo
  close (unit = 101)

  open  (unit = 101, file = 'Stage1/PsiSequential.txt')
  do i = 1, NRBOX
     do j = 1, NZBOX
  ...
  open  (unit = 101, file = 'Stage1/Boundary.txt')
  write (101, '(2e17.9)') (RBOUND (i)/R0, ZBOUND (i)/R0, i = 1, NBOUND)
  close (unit = 101)

  open  (unit = 101, file = 'Stage1/Limiter.txt')
