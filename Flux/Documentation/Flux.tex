...
\begin{align}
\delta B_r(r,\theta,\varphi)&= {\rm i}\sum_j \frac{1}{m_j}\,\frac{d\chi_j}{dr}\,{\rm e}^{\,{\rm i}\,(m_j\,\theta-n\,\varphi)},\\[0.5ex]
\delta B_\theta (r,\theta,\varphi)&=-\sum_j\chi_j(r)\,{\rm e}^{\,{\rm i}\,(m_j\,\theta-n\,\varphi)},\\[0.5ex]
\delta B_\varphi(r,\theta,\varphi)&=n\sum_j\frac{\chi_j(r)}{m_j}\,{\rm e}^{\,{\rm i}\,(m_j\,\theta-n\,\varphi)},
\end{align}
