...
subroutine NameListRead (NFLOW, STAGE5, INTF, INTN, INTU, OLD, FREQ, LIN, MID, DT, TIME, SCALE, PMAX,&
  ...
  namelist /PHASE_CONTROL/   STAGE5, NFLOW, INTF, INTN, INTU, OLD, FREQ, LIN, MID, DT, TIME, SCALE, PMAX
