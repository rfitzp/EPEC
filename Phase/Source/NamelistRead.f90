...
subroutine NameListRead (NFLOW, STAGE5, INTF, INTN, INTU, OLD, FREQ, LIN, MID, COPT, DT, TSTART, TEND, SCALE, PMAX,&
  ...
  namelist /PHASE_CONTROL/   STAGE5, NFLOW, INTF, INTN, INTU, OLD, FREQ, LIN, MID, COPT, DT, TSTART, TEND, SCALE,&
