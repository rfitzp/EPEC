...
E_{sw\,k}\,{\mit\Psi}_{w\,k}+ \hat{E}_{kk}\,\chi_k,\\[0.5ex]
\hat{\tau}_w\,\frac{d{\mit\Psi}_{w\,k}}{d\hat{t}}&= E_{ww\,k}\,{\mit\Psi}_{w\,k} +E_{sw\,k}\,{\mit\Psi}_k,\label{e2d}
\end{align}
...
f_k&=f_{b\,k}+f_{c\,k}+f_{p\,k}-f_{s\,k}+ \frac{E_{sw\,k}^{\,2}}{E_{ww\,k}},
\end{align}
...
P_{2\,k} &= 0.41\left(A_k^{\,2}\left[\ln\left(\frac{1}{r_k}\right)+4.85\right] - \frac{{\mit\Sigma}_{nw\,k}'\,A_k}{2} - B_k - 0.44\,A_k\right),\\[0.5ex]
...
X_{w\,k} &= \hat{\mit\Psi}_{w\,k}\,\cos\varphi_{w\,k},\\[0.5ex]
Y_{w\,k} &= \hat{\mit\Psi}_{w\,k}\,\sin\varphi_{w\,k}.
\end{align}
...
&\phantom{=}+ E_{sw\,k}\,(X_{w\,k} - {\rm i}\,Y_{w\,k})+ \hat{E}_{kk}\,\hat{\chi}_k\,(\cos\zeta_k - {\rm i }\,\sin\zeta_k),\nonumber\\[0.5ex]
\hat{\tau}_w\,\frac{d}{d\hat{t}}\,(X_{w\,k} - {\rm i}\,Y_{w\,k})&=E_{ww\,k}\,(X_{w\,k} 
- {\rm i}\,Y_{w\,k})+E_{sw\,k}\,(X_{k} - {\rm i}\,Y_{k}).\nonumber
\end{align}
Follows that
\begin{align}
...
&\phantom{=}+E_{sw\,k}\,X_{w\,k}+ \hat{E}_{kk}\,\hat{\chi}_k\,\cos\zeta_k,\nonumber\\[0.5ex]
...
&\phantom{=} +E_{sw\,k}\,Y_{w\,k}+ \hat{E}_{kk}\,\hat{\chi}_k\,\sin\zeta_k,\nonumber\\[0.5ex]
\hat{\tau}_w\,\frac{dX_{w\,k}}{d\hat{t}}&= E_{ww\,k}\,X_{w\,k}+ E_{sw\,k}\,X_k,\\[0.5ex]
\hat{\tau}_w\,\frac{dY_{w\,k}}{d\hat{t}}&= E_{ww\,k}\,Y_{w\,k}+ E_{sw\,k}\,Y_k.
\end{align}
where
...
+E_{sw\,k}\,\hat{\mit\Psi}_k\,\hat{\mit\Psi}_{w\,k}\,\sin(\varphi_k-\varphi_{w\,k})\nonumber\\[0.5ex]
&\phantom{=}
