...
Equation~(\ref{e15}) represents a {\em minor}\/ improvement to Eq.~(D1) of Ref.~\onlinecite{rftor} in which the interpolation between the
...
a {\em major}\/ improvement to Eq.~(D6) of Ref.~\onlinecite{rftor} that takes into  account the finite slip-frequencies of the magnetic island chains induced at
...
plasma current is slowly ramped in order to scan the magnetic safety-factor.\cite{d3d,d3d2} This discharge is described in more detail in Sect.~III.B of Ref.~\onlinecite{rftor1}.
...
linear layer width. The fact that the linear calculation is highly inaccurate confirms the conclusion reached in Ref.~\onlinecite{rf1}
