...
detail in Ref.~\onlinecite{rftor}. In the light of the composite cylindrical resonant response model developed in Sect.~\ref{s2}, we shall
modify the resonant  response component of the aforementioned toroidal  model; this component is described in Appendix~D of Ref.~\onlinecite{rftor}.
...
\bibitem{rftor1} R.~Fitzpatrick,  ``Modelling $q_{95}$ Windows for the Suppression of Edge Localized
