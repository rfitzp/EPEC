...
extern "C" void NameListRead (int* FLUX_NTOR, int* FLUX_MMIN, int* FLUX_MMAX,
			      ...
			      int* PHASE, int* PHASE_MID, int* PHASE_INTN, int* PHASE_INTU, int* PHASE_STAGE2, int* PHASE_OLD, int* PHASE_VER2, int* PHASE_FREQ, int* PHASE_LIN, double* PHASE_SCALE, 
...
void IslandDynamics ()
{
  ...
  printf ("NEO_INTP = %2d  NEO_INTF = %2d  NEO_IMPURITY = %2d  NEO_NEUTRAL = %2d  NEO_FREQ = %2d  NEO_NTYPE = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	  NEO_INTP, NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  printf ("PHASE = %2d  PHASE_MID = %2d  PHASE_INTN = %2d  PHASE_INTU = %2d  PHASE_STAGE5 = %2d  PHASE_OLD = %2d  PHASE_VER2 = %2d  PHASE_FREQ = %2d  PHASE_LIN = %2d  PHASE_SCALE = %11.4e\n",
	  PHASE, PHASE_MID, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, PHASE_VER2, PHASE_FREQ, PHASE_LIN, PHASE_SCALE);
  ...
  fprintf (monitor, "NEO_INTP = %2d  NEO_INTF = %2d  NEO_IMPURITY = %2d  NEO_NEUTRAL = %2d  NEO_FREQ = %2d  NEO_NTYPE = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	   NEO_INTP, NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  fprintf (monitor, "PHASE = %2d  PHASE_MID = %2d  PHASE_INTN = %2d  PHASE_INTU = %2d  PHASE_STAGE5 = %2d  PHASE_OLD = %2d  PHASE_VER2 = %2d  PHASE_FREQ = %2d  PHASE_SCALE = %11.4e\n",
	   PHASE, PHASE_MID, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, PHASE_VER2, PHASE_FREQ, PHASE_SCALE);
  ...
  fprintf (namelist, "NEO_INTP = %2d  NEO_INTF = %2d  NEO_IMPURITY = %2d  NEO_NEUTRAL = %2d  NEO_FREQ = %2d  NEO_NTYPE = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	   NEO_INTP, NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  fprintf (namelist, "PHASE = %2d  PHASE_MID = %2d  PHASE_INTN = %2d  PHASE_INTU = %2d  PHASE_STAGE5 = %2d  PHASE_OLD = %2d  PHASE_VER2 = %2d  PHASE_FREQ = %2d  PHASE_LIN = %2d  PHASE_SCALE = %11.4e\n",
	   PHASE, PHASE_MID, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, PHASE_VER2, PHASE_FREQ, PHASE_LIN, PHASE_SCALE);
  ...
  do
	...
	{
	  if (lock)
	    sprintf (PHASEstring, "cd ../Phase-2.x; ./phase -m %d -f %d -n %d -u %d -s %2d -o %2d -F %2d -l %2d -t %16.9e -T %16.9e -S %16.9e ",
		     PHASE_MID, PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, PHASE_FREQ, PHASE_LIN, Time, Time + DT, PHASE_SCALE);
	  else
	    sprintf (PHASEstring, "cd ../Phase-2.x; ./phase -m %d -f %d -n %d -u %d -s %2d -o %2d -F %2d -l %2d -t %16.9e -T %16.9e -S %16.9e",
		     PHASE_MID, PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, lock, PHASE_FREQ, PHASE_LIN, Time, Time + DT, PHASE_SCALE);
	}
      else
	{
	   if (lock)
	    sprintf (PHASEstring, "cd ../Phase-1.x; ./phase -f %d -n %d -u %d -s %2d -o %2d -t %16.9e -S %16.2e ",
		     PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, Time, PHASE_SCALE);
	  else
	    sprintf (PHASEstring, "cd ../Phase-1.x; ./phase -f %d -n %d -u %d -s %2d -o %2d -t %16.9e -S %16.2e ",
		     PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, lock, Time, PHASE_SCALE);
	}
      lock = 1;
