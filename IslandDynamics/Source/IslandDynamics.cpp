...
extern "C" void NameListRead (int* FLUX_NTOR, int* FLUX_MMIN, int* FLUX_MMAX,
			      ...
			      int* PHASE, int* PHASE_INTN, int* PHASE_STAGE2, int* PHASE_OLD, int* PHASE_FREQ, 
...
void IslandDynamics ()
{
  ...
  int    PHASE_FREQ;     // If != 0 then use island width dependent natural frequency (overrides NEO_FREQ)
  ...
  NameListRead (&FLUX_NTOR, &FLUX_MMIN, &FLUX_MMAX,
		...
		&PHASE, &PHASE_INTN, &PHASE_STAGE5, &PHASE_OLD, &PHASE_FREQ, 
  ...
  printf ("NEO_INTF   = %2d  NEO_IMPURITY = %2d           NEO_NEUTRAL  = %2d           NEO_FREQ  = %2d           NEO_NTYPE  = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	  NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  printf ("PHASE      = %2d  PHASE_INTN   = %2d           PHASE_STAGE5 = %2d           PHASE_OLD = %2d           PHASE_FREQ = %2d\n",
	  PHASE, PHASE_INTN, PHASE_STAGE5, PHASE_OLD, PHASE_FREQ);
  ...
  fprintf (monitor, "NEO_INTF   = %2d  NEO_IMPURITY = %2d           NEO_NEUTRAL  = %2d           NEO_FREQ  = %2d           NEO_NTYPE  = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	  NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  fprintf (monitor, "PHASE      = %2d  PHASE_INTN   = %2d           PHASE_STAGE5 = %2d           PHASE_OLD = %2d           PHASE_FREQ = %2d\n",
	   PHASE, PHASE_INTN, PHASE_STAGE5, PHASE_OLD, PHASE_FREQ);
  ...
  fprintf (namelist, "NEO_INTF   = %2d  NEO_IMPURITY = %2d           NEO_NEUTRAL  = %2d           NEO_FREQ  = %2d           NEO_NTYPE  = %2d  NEO_NN = %11.4e  NEO_LN = %11.4e  NEO_YN = %11.4e\n",
	  NEO_INTF, NEO_IMPURITY, NEO_NEUTRAL, NEO_FREQ, NEO_NTYPE, NEO_NN, NEO_LN, NEO_YN);
  fprintf (namelist, "PHASE      = %2d  PHASE_INTN   = %2d           PHASE_STAGE5 = %2d           PHASE_OLD = %2d           PHASE_FREQ = %2d\n",
	   PHASE, PHASE_INTN, PHASE_STAGE5, PHASE_OLD, PHASE_FREQ);
  ...
  do
    {
      ...
      if (lock)
	sprintf (PHASEstring, "cd ../Phase-2.0; ./phase -f %d -n %d -u %d -s %2d -o %2d -t %16.9e ",
		 PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, Time);
      else
	sprintf (PHASEstring, "cd ../Phase-2.0; ./phase -f %d -n %d -u %d -s %2d -o %2d -F %2d -t %16.9e ",
