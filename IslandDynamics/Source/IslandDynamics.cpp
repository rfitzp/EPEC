...
extern "C" void NameListRead (int* PHASE_MID, int* PHASE_COPT, double* PHASE_CORE, int* PHASE_LIN, int* PHASE_FREQ, int* PHASE_HIGH, int* PHASE_RATS,
			      int* PHASE_NATS, double* PHASE_SCALE, double* PHASE_CHIR, int* RESTART, double* TSTART, double* TEND, double* DT); 
...
void IslandDynamics (double IRMP)
{
  ...
  NameListRead (&PHASE_MID, &PHASE_COPT, &PHASE_CORE, &PHASE_LIN, &PHASE_FREQ, 
		&PHASE_HIGH, &PHASE_RATS, &PHASE_NATS, &PHASE_SCALE, &PHASE_CHIR, &RESTART, &TSTART, &TEND, &DT);

  printf ("Reading Inputs/Island.nml:\n");
  printf ("PHASE_MID = %2d  PHASE_COPT = %2d  PHASE_CORE = %11.4e PHASE_LIN = %2d  PHASE_FREQ = %2d  PHASE_HIGH = %2d  PHASE_RATS = %2d  PHASE_NATS = %2d  PHASE_SCALE = %11.4e  PHASE_CHIR = %11.4e\n",
	  PHASE_MID, PHASE_COPT, PHASE_CORE, PHASE_LIN, PHASE_FREQ, PHASE_HIGH, PHASE_RATS, PHASE_NATS, PHASE_SCALE, PHASE_CHIR);
  ...
  fprintf (monitor, "PHASE_MID = %2d  PHASE_COPT = %2d  PHASE_CORE = %11.4e PHASE_LIN = %2d  PHASE_FREQ = %2d  PHASE_HIGH = %2d  PHASE_RATS = %2d  PHASE_NATS = %2d  PHASE_SCALE = %11.4e  PHASE_CHIR = %11.4e\n",
	   PHASE_MID, PHASE_COPT, PHASE_CORE, PHASE_LIN, PHASE_FREQ, PHASE_HIGH, PHASE_RATS, PHASE_NATS, PHASE_SCALE, PHASE_CHIR);
  ...
  fprintf (namelist, "PHASE_MID = %2d  PHASE_COPT = %2d  PHASE_CORE = %11.4e PHASE_LIN = %2d  PHASE_FREQ = %2d  PHASE_HIGH = %2d  PHASE_RATS = %2d  PHASE_NATS = %2d  PHASE_SCALE = %11.4e  PHASE_CHIR = %11.4e\n",
	   PHASE_MID, PHASE_COPT, PHASE_CORE, PHASE_LIN, PHASE_FREQ, PHASE_HIGH, PHASE_RATS, PHASE_NATS, PHASE_SCALE, PHASE_CHIR);
  ...
  do
    {
      ...
      if (lock)
	sprintf (PHASEstring, "cd ../Phase; ./phase -m %d -C %d -f %d -n %d -u %d -s %2d -o %2d -l %2d -t %16.9e -T %16.9e -S %16.9e -c %11.4e -i %11.4e -H %2d -r %2d -D %16.9e -F %2d -N %2d",
		 PHASE_MID, PHASE_COPT, PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, PHASE_OLD, PHASE_LIN, Time, Time + DT, PHASE_SCALE, PHASE_CHIR, IRMP, PHASE_HIGH, PHASE_RATS, PHASE_CORE, PHASE_FREQ, PHASE_NATS);
      else
	sprintf (PHASEstring, "cd ../Phase; ./phase -m %d -C %d -f %d -n %d -u %d -s %2d -o %2d -l %2d -t %16.9e -T %16.9e -S %16.9e -c %11.4e -i %11.4e -H %2d -r %2d -D %16.9e -F %2d -N %2d",
		 PHASE_MID, PHASE_COPT, PHASE_INTF, PHASE_INTN, PHASE_INTU, PHASE_STAGE5, lock, PHASE_LIN, Time, Time + DT, PHASE_SCALE, PHASE_CHIR, IRMP, PHASE_HIGH, PHASE_RATS, PHASE_CORE, PHASE_FREQ, PHASE_NATS);
