...
\begin{align}
[F^{\,ee}+\mu^{\,e}]\,(u_\theta^{\,e})& = -\left([F^{\,ee}]-[F^{\,ei}]-[F^{eI}]\right)(V_E)-[F^{\,ei}]\,[G^{\,ii}]\,(V_E)\nonumber\\[0.5ex]&
...
\begin{align}
[F^{\,ee}+\mu^{\,e}]\,(u_\theta^{\,e})& =-[F^{\,ei}]\,[G^{\,ii}]\,(V_E)-[F^{\,ee}]\,(V_\ast^{\,e})\nonumber\\[0.5ex]
&\phantom{=}
...
Follows that
\begin{align}
(u_\theta^{\,e}) &=-[P^{\,ei}]\,(V_E)-[L^{\,ee}]\,(V_{\ast}^{\,e})- [L^{\,ei}]\,(V_{\ast}^{\,i}) -[L^{\,eI}]\,(V_\ast^{\,I}) 
\nonumber\\[0.5ex]
&\phantom{=}+ {\mit\Omega}_e\,\tau_{ee}\,[Q^{\,ee}]\,(E_\parallel),\\[0.5ex]
(u_\parallel^{\,e}) &= ([1]-[P^{\,ei}])\,(V_E) + (1-[L^{\,ee}])\,(V_{\ast}^{\,e}) - [L^{\,ei}]\,(V_{\ast}^{\,i}) -[L^{\,eI}]\,(V_\ast^{\,I})\nonumber\\[0.5ex]&\phantom{=}
...
&=-\left(n_i\,e_i\,[G^{\,ii}]+n_e\,e_e\,[P^{\,ei}]\right)(V_E)
\nonumber\\[0.5ex]
...
and 
\begin{align}
\omega_{{\rm nc}\,i}&= -G^{\,ii}_{00}\,\omega_E-L^{\,ii}_{00}\,\omega_{\ast\,i}-
L^{\,iI}_{00}\,\omega_{\ast\,I}+L^{\,ii}_{01}\left(\frac{\eta_i}{1+\eta_i}\right)\omega_{\ast\,i}+L^{\,iI}_{01}\left(\frac{\eta_I}{1+\eta_I}\right)\omega_{\ast\,I},\\[0.5ex]
\omega_{{\rm nc}\,I}&= -L^{\,II}_{00}\,\omega_{\ast\,I}-
L^{\,Ii}_{00}\,\omega_{\ast\,i}+L^{\,II}_{01}\left(\frac{\eta_I}{1+\eta_I}\right)\omega_{\ast\,I}+L^{\,Ii}_{01}\left(\frac{\eta_i}{1+\eta_i}\right)\omega_{\ast\,i}.
\end{align}
...
where
\begin{align}
\frac{\langle j_{\rm bootstrap}\,B\rangle}{I}&=-\left\{P_{00}^{\,ei}-\left(\frac{Z_I-Z_{\rm eff}}{Z_I-1}\right)G^{\,ii}_{00}\right\}n_e\,e\,\frac{d{\mit\Phi}}{d\psi}\nonumber\\[0.5ex]
...
where
\begin{align}
\omega_{\parallel\,{\rm bootstrap}}&=\left\{P_{00}^{\,ei}-\left(\frac{Z_I-Z_{\rm eff}}{Z_I-1}\right)G^{\,ii}_{00}\right\}\omega_E\nonumber\\[0.5ex]
