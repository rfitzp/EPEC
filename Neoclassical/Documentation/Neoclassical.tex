...
\end{equation}
(Last term can be justified in cylindrical coordinates.)
...
Species are $e$, $i$, and $I$, with $e_i=-e_e=e$ and $e_I= Z_I$.  Let 
\begin{equation}
...
N^{\,ea}_{11}& =0,
\end{align}
for $a=i$, $I$, where we have neglected terms of order $(m_e/m_a)^{\,1/2}$. Finally,
\begin{align}
M^{\,ae}_{00} &= -\frac{m_a}{m_e}\,x_{ea}^{\,3},\\[0.5ex]
M^{\,ae}_{01}&=0= M^{\,ae}_{10},\\[0.5ex]
M^{\,ae}_{11}& = -\frac{15}{2}\,\frac{T_e}{T_a}\,\frac{m_a}{m_e}\,x_{ea}^{\,3},\\[0.5ex]
N^{\,ae}_{00} &= \frac{m_a}{m_e}\,x_{ea}^{\,3},\\[0.5ex]
N^{\,ae}_{01}&= \frac{3}{2}\,\frac{m_a}{m_e}\,x_{ea}^{\,3},\\[0.5ex]
N^{\,ae}_{10}&=0\\[0.5ex]
N^{\,ae}_{11}& =0,
\end{align}
for $a=i$, $I$, where we have only retained terms of order $(m_e/m_a)^{\,1/2}$.

Now,
\begin{align}
l_{jk}^{\,ii} & = \frac{n_i\,m_i}{\tau_{ii}}\left[\left(\sum_a \frac{n_a\,e_a^{\,2}}{n_i\,e_i^{\,2}}\,M^{\,ia}_{jk}\right) + N^{\,ii}_{jk}\right]\\[0.5ex]
&= \frac{n_i\,m_i}{\tau_{ii}}\left(M^{\,ii}_{jk}+N^{\,ii}_{jk}+\alpha\,M^{\,iI}_{jk}\right)+ \frac{n_i\,m_i}{\tau_{ie}}\,M_{ij}^{\,ie},
\end{align}
where 
\begin{equation}
...
Thus,
\begin{align}
l^{\,ii}_{00} &= -\frac{n_i\,m_i}{\tau_{ii}}\,\frac{\alpha\,(1+m_i/m_I)}{(1+x_{iI}^{\,2})^{\,3/2}} - \frac{n_e\,m_e}{\tau_{ee}}\,Z_{{\rm eff}\,i},\\[0.5ex]
...
l^{\,ii}_{11}& = -\frac{n_i\,m_i}{\tau_{ii}}\,\left\{\sqrt{2}+ \frac{\alpha\,[13/4+4\,x_{iI}^{\,2}+(15/2)\,x_{iI}^{\,4}]}{(1+x_{iI}^{\,2})^{\,5/2}}\right\}- \frac{n_e\,m_e}{\tau_{ee}}\,\frac{15}{2}\,\frac{T_e}{T_i}\,Z_{{\rm eff}\,i}.
\end{align}
Here,  
\begin{equation}
...
Now,
\begin{align}
l_{jk}^{\,II} & = \frac{n_I\,m_I}{\tau_{II}}\left[\left(\sum_a \frac{n_a\,e_a^{\,2}}{n_I\,e_I^{\,2}}\,M^{\,Ia}_{jk}\right) + N^{\,II}_{jk}\right]+ \frac{n_I\,m_I}{\tau_{Ie}}\,M_{ij}^{Ie}\\[0.5ex]
...
so
\begin{align}
l^{\,II}_{00} &= -\frac{n_i\,m_i}{\tau_{ii}}\,\frac{m_i}{m_I}\,x_{Ii}^{\,3}\frac{\alpha\,(1+m_I/m_i)}{(1+x_{Ii}^{\,2})^{\,3/2}}- \frac{n_e\,m_e}{\tau_{ee}}\,Z_{{\rm eff}\,I},\\[0.5ex]
...
\right\} - \frac{n_e\,m_e}{\tau_{ee}}\,\frac{15}{2}\,\frac{T_e}{T_I}\,Z_{{\rm eff}\,I}.
\end{align}
Also, 
\begin{equation}
...
Now, 
\begin{align}
l_{jk}^{\,ie} & = \frac{n_i\,m_i}{\tau_{ie}}\, N^{\,ie}_{jk},
\end{align}
so
\begin{align}
l^{\,ie}_{00} &= \frac{n_e\,m_e}{\tau_{ee}}\,Z_{{\rm eff}\,i},\\[0.5ex]
l^{\,ie}_{01}&= \frac{n_e\,m_e}{\tau_{ee}}\,\frac{3}{2}\,Z_{{\rm eff}\,i},\\[0.5ex]
l^{\,ie}_{10}&= 0,\\[0.5ex]
l^{\,ie}_{11}& =0.
\end{align}
Finally, 
...
Thus, 
\begin{align}
(F^{\,i})&= \frac{n_i\,m_i}{\tau_{ii}}\left\{-\left[F^{\,ii}\right]\,(u^{\,i})+\left[F^{\,iI}\right]\,(u^{\,I})\right\}+\frac{n_e\,m_e}{\tau_{ee}}\left\{-\left[E^{\,ii}\right]\,(u^{\,i})+\left[E^{\,ie}\right]\,(u^{\,e})\right\},\\[0.5ex]
(F^{\,I})&= \frac{n_i\,m_i}{\tau_{ii}}\left\{\left[F^{\,Ii}\right]\,(u^{\,i})-\left[F^{\,II}\right]\,(u^{\,I})\right\}+\frac{n_e\,m_e}{\tau_{ee}}\left\{-\left[E^{\,II}\right]\,(u^{\,i})+\left[E^{\,Ie}\right]\,(u^{\,e})\right\},
\end{align}
where
\begin{align}
...
15/2+4\,x_{iI}^{\,2}+(13/4)\,x_{iI}^{\,4}]}{(1+x_{iI}^{\,2})^{\,5/2}}\right\},\\[0.5ex]
E_{00}^{\,ii} &= Z_{{\rm eff}\,i},\\[0.5ex]
E_{01}^{\,ii}&= 0,\\[0.5ex]
E_{10}^{\,ii} &= 0,\\[0.5ex]
E_{11}^{\,ii}&= \frac{15}{2}\,\frac{T_e}{T_i}\,Z_{{\rm eff}\,i},\\[0.5ex]
E_{00}^{\,II} &= Z_{{\rm eff}\,I},\\[0.5ex]
E_{01}^{\,II}&= 0,\\[0.5ex]
E_{10}^{\,II} &= 0,\\[0.5ex]
E_{11}^{\,II}&= \frac{15}{2}\,\frac{T_e}{T_I}\,Z_{{\rm eff}\,I},\\[0.5ex]
E_{00}^{\,ie} &= Z_{{\rm eff}\,i},\\[0.5ex]
E_{01}^{\,ie}&= \frac{3}{2}\,Z_{{\rm eff}\,i},\\[0.5ex]
E_{10}^{\,ie} &= 0,\\[0.5ex]
E_{11}^{\,ie}&=0,\\[0.5ex]
E_{00}^{\,Ie} &= Z_{{\rm eff}\,I},\\[0.5ex]
E_{01}^{\,Ie}&=  \frac{3}{2}\,Z_{{\rm eff}\,I},\\[0.5ex]
...
Note that 
\begin{align}
F^{\,ii}_{0j}&=F^{\,Ii}_{0j},\\[0.5ex]
F^{\,II}_{0j}&=F^{\,iI}_{0j}, \\[0.5ex]
F^{\,ee}_{0j} &=E^{\,ie}_{0j} + E^{\,Ie}_{0j},\\[0.5ex]
F^{\,ei}_{0j}&=E^{\,ii}_{0j},\\[0.5ex]
F^{\,eI}_{0j} &= E^{\,II}_{0j}
\end{align}
for $j=0$, $1$, which implies
that $\vec{F}_0^{\,i}+ \vec{F}_0^{\,I}+\vec{F}_0^{\,e}= 0$. 
This is a statement of collisional momentum conservation.
Furthermore,
\begin{align}
F^{\,ii}_{j0}&=F^{\,iI}_{j0},\\[0.5ex]
 F^{\,II}_{j0}&=F^{\,Ii}_{j0},\\[0.5ex]
F^{\,ee}_{j0}&= F^{\,ei}_{j0} + F^{\,eI}_{j0},\\[0.5ex]
E_{j0}^{\,ii}&= E_{j0}^{\,ie},\\[0.5ex]
E_{j0}^{\,II}&=E_{j0}^{\,Ie}.
\end{align}
These relations ensure that $\vec{F}_0^{\,a}$ and $\vec{F}_1^{\,a}$ are invariant under Galilean transformations. 
...
We have
\begin{equation}
K_{ij}^{\,a} = g\,\frac{8}{3\sqrt{\pi}}\int_0^\infty
\frac{e^{-x^2}\,x^{\,8+2\,(i+j)}\,\hat{\nu}_D^{\,a}(x)\,dx}{[x^{\,3}+\nu_{\ast\,a}\,\hat{\nu}_D^{\,a}(x)]\,[x^{\,3}+(5\pi/8)\,(\omega_{t\,a}\,\tau_{aa})^{-1}\,\hat{\nu}_T^{\,a}(x)]},
\end{equation}
and 
\begin{align}
\hat{\nu}_D^{\,a}(x)&=\frac{3\sqrt{\pi}}{4}\sum_b 
\frac{n_b\,e_b^{\,2}}{n_a\,e_a^{\,2}}\left[\left(1-\frac{x_{ab}^{\,2}}{2\,x^{\,2}}\right)\psi\!\left(\frac{x}{x_{ab}}\right)
...
In particular,
\begin{align}
K_{ij}^{\,i} &= g\,\frac{8}{3\sqrt{\pi}}\int_0^\infty
\frac{e^{-x^2}\,x^{\,8+2\,(i+j)}\,\hat{\nu}_D^{\,i}(x)\,dx}{[x^{\,3}+\nu_{\ast\,i}\,\hat{\nu}_D^{\,i}(x)]\,[x^{\,3}+(5\pi/8)\,(\omega_{t\,i}\,\tau_{ii})^{\,-1}\,\hat{\nu}_T^{\,i}(x)]},\\[0.5ex]
\hat{\nu}_D^{\,i}&= \frac{3\sqrt{\pi}}{4}\left[\left(1-\frac{1}{2\,x^{\,2}}\right)\psi(x)+\psi'(x)\right]\frac{1}{x}\nonumber\\[0.5ex]&\phantom{=}
+\frac{3\sqrt{\pi}}{4}\,\alpha\left[\left(1-\frac{x_{iI}^{\,2}}{2\,x^{\,2}}\right)\psi\!\left(\frac{x}{x_{iI}}\right)
...
\frac{e^{-x^2}\,x^{\,8+2\,(i+j)}\,\hat{\nu}_D^{\,I}(x)\,dx}{[x^{\,3}+\nu_{\ast\,I}\,\hat{\nu}_D^{\,I}(x)]\,[x^{\,3}+(5\pi/8)\,(\omega_{t\,I}\,\tau_{II})^{\,-1}\,\hat{\nu}_T^{\,I}(x)]},\\[0.5ex]
\hat{\nu}_D^{\,I}&= \frac{3\sqrt{\pi}}{4}\left[\left(1-\frac{1}{2\,x^{\,2}}\right)\psi(x)+\psi'(x)\right]\frac{1}{x}\nonumber\\[0.5ex]&\phantom{=}
+\frac{3\sqrt{\pi}}{4}\,\alpha^{\,-1}\left[\left(1-\frac{x_{Ii}^{\,2}}{2\,x^{\,2}}\right)\psi\!\left(\frac{x}{x_{Ii}}\right)
+\psi'\!\left(\frac{x}{x_{Ii}}\right)\right]\frac{1}{x},\\[0.5ex]
\hat{\nu}_\epsilon^{\,I}&= \frac{3\sqrt{\pi}}{2}\left[\psi(x)-\psi'(x)\right]\frac{1}{x}\nonumber\\[0.5ex]&\phantom{=}
...
and
\begin{align}
K_{ij}^{\,e}& = g\,\frac{8}{3\sqrt{\pi}}\int_0^\infty
\frac{e^{-x^2}\,x^{\,9+2\,(i+j)}\,\hat{\nu}_D^{\,e}(x)\,dx}{[x^{\,4}+\nu_{\ast\,e}\,\hat{\nu}_D^{\,e}(x)]\,[x^{\,4}+(5\pi/8)\,(\omega_{t\,e}\,\tau_{ee})^{\,-1}\,\hat{\nu}_T^{\,e}(x)]},\\[0.5ex]
\hat{\nu}_D^{\,e}&= \frac{3\sqrt{\pi}}{4}\left[\left(1-\frac{1}{2\,x^{\,2}}\right)\psi(x)+\psi'(x)\right]+\frac{3\sqrt{\pi}}{4}\,Z_{\rm eff},\\[0.5ex]
...
(u_{\parallel}^{\,I})\right\}\nonumber\\[0.5ex]
&\phantom{=}+\frac{n_e\,m_e}{\tau_{ee}}\left\{-\left[E^{\,ii}\right]\,(u^{\,i})+\left[E^{\,ie}\right]\,(u^{\,e})\right\},\\[0.5ex]
...
\end{equation}
 Note that we have neglected  terms that are of order $(m_e/m_i)^{1/2}$  in the ion force and heat balance equations.
...
(V_\ast^{\,I})\end{array}\right]\nonumber\\[0.5ex]&\phantom{=}-\tau_{ii}\,\langle\sigma\,v\rangle_i^{\,cx}\,\langle n_n\rangle\left[\begin{array}{c} (V_E)\\[0.5ex]
(0)\end{array}\right].
\end{align}
Let
\begin{equation}
...
Can also write
\begin{equation}
\omega_{\parallel\,{\rm bootstrap}} = -(\omega_{\,\ast\,e} + \omega_{{\rm nc}\,e}) + \frac{n_i}{n_e}\left(\omega_{\ast\,i} + \omega_{{\rm nc}\,i}\right)+ \frac{Z_I\,n_I}{n_e}\left(\omega_{\ast\,I} + \omega_{{\rm nc}\,I}\right),
\end{equation}
where
\begin{align}
