...
void Neoclassical::fFileInterpolateQuadratic (char* fFile1, double time1, char* fFile2, double time2, char* fFile, double time)
{
  ...
  double          r1_2, r2_2, r3_2, r4_2, r5_2, r6_2, r7_2, r8_2, r9_2;
  ...
  if (fscanf (file, "%lf %lf %lf %lf %lf %lf %lf %lf %lf %d %d %d",
	      &r1_2, &r2_2, &r3_2, &r4_2, &r5_2, &r6_2, &r7_2, &r8_2, &r9_2, &NPSI_2, &NTOR_2, &nres_2) != 12)
    {
  ...
  for (int j = 0; j < nres_0; j++)
    fprintf (file, "%d %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e\n",
	     mres_0(j), u1_0(j), u2_0(j), u3_0(j), u4_0(j), u5_0(j), u6_0(j), u7_0(j), u8_0(j), u9_0(j), u10_0(j), u10_0(j), u11_0(j), u12_0(j), u13_0(j), u14_0(j));
  for (int j = 0; j < nres_0; j++)
    for (int k = 0; k < nres_0; k++)
      fprintf (file, "%d %d %16.9e %16.9e\n",
	       mres_0(j), mres_0(k), Freal_0(j, k), Fimag_0(j, k));
...
void Neoclassical::fFileInterpolateCubic (char* fFile1, double time1, char* fFile2, double time2, char* fFile3, double time3, char* fFile, double time)
{
  ...
  double          r1_3, r2_3, r3_3, r4_3, r5_3, r6_3, r7_3, r8_3, r9_3;
  ...
  if (fscanf (file, "%lf %lf %lf %lf %lf %lf %lf %lf %lf %d %d %d",
	      &r1_3, &r2_3, &r3_3, &r4_3, &r5_3, &r6_3, &r7_3, &r8_3, &r9_3, &NPSI_3, &NTOR_3, &nres_3) != 12)
    {
					    ...
					    char* fFile4, double time4, char* fFile, double time)
{
  ...
  double          r1_4, r2_4, r3_4, r4_4, r5_4, r6_4, r7_4, r8_4, r9_4;
  ...
  for (int j = 0; j < nres_1; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  &mres_1(j), &u1_1(j), &u2_1(j), &u3_1(j), &u4_1(j), &u5_1(j), &u6_1(j), &u7_1(j), &u8_1(j), &u9_1(j), &u10_1(j), &u11_0(j), &u12_0(j), &u13_0(j), &u14_0(j)) != 15)
	{
  ...
  for (int j = 0; j < nres_2; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  &mres_2(j), &u1_2(j), &u2_2(j), &u3_2(j), &u4_2(j), &u5_2(j), &u6_2(j), &u7_2(j), &u8_2(j), &u9_2(j), &u10_2(j), &u10_2(j), &u11_2(j), &u12_2(j), &u13_2(j), &u14_2(j)) != 15)
	{
  ...
  if (fscanf (file, "%lf %lf %lf %lf %lf %lf %lf %lf %lf %d %d %d",
	      &r1_4, &r2_4, &r3_4, &r4_4, &r5_4, &r6_4, &r7_4, &r8_4, &r9_4, &NPSI_4, &NTOR_4, &nres_4) != 12)
    {
  ...
  Freal_4.resize (nres_4, nres_4);
  Fimag_4.resize (nres_4, nres_4);
  ...
  Ereal_4.resize (nres_4, nres_4);
  Eimag_4.resize (nres_4, nres_4);
  ...
  EIreal_4.resize (nres_4);
  EIimag_4.resize (nres_4);
  EOreal_4.resize (nres_4);
  EOimag_4.resize (nres_4);
