...
void Neoclassical::fFileInterpolateLinear (char* fFile1, double time1, char* fFile, double time)
{
  ...
  Array<int, 1>   mres_1;
  Array<double,1> u1_1, u2_1, u3_1, u4_1, u5_1, u6_1, u7_1, u8_1, u9_1, u10_1, u11_1, u12_1, u13_1, u14_1, u15_1, u16_1;
  ...
  Array<int, 1>   mres_0;
  Array<double,1> u1_0, u2_0, u3_0, u4_0, u5_0, u6_0, u7_0, u8_0, u9_0, u10_0, u11_0, u12_0, u13_0, u14_0, u15_0, u16_0;
  ...
  for (int j = 0; j < nres_1; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  &mres_1(j), &u1_1(j), &u2_1(j), &u3_1(j), &u4_1(j), &u5_1(j), &u6_1(j), &u7_1(j), &u8_1(j), &u9_1(j),
		  &u10_1(j), &u11_1(j), &u12_1(j), &u13_1(j), &u14_1(j), &u15_1(j), &u16_1(j)) != 17)
	{
  ...
  EIreal_1.resize (nres_1); EIimag_1.resize (nres_1);
  EOreal_1.resize (nres_1); EOimag_1.resize (nres_1);
  ...
  for (int j = 0; j < nres_0; j++)
    fprintf (file, "%d %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e %16.9e\n",
	     mres_0(j), u1_0(j), u2_0(j), u3_0(j), u4_0(j), u5_0(j), u6_0(j), u7_0(j), u8_0(j), u9_0(j), u10_0(j), u11_0(j), u12_0(j), u13_0(j), u14_0(j), u15_0(j), u16_0(j));
  for (int j = 0; j < nres_0; j++)
    for (int k = 0; k < nres_0; k++)
...
void Neoclassical::fFileInterpolateQuadratic (char* fFile1, double time1, char* fFile2, double time2, char* fFile, double time)
{
  ...
  Array<int, 1>   mres_2;
  Array<double,1> u1_2, u2_2, u3_2, u4_2, u5_2, u6_2, u7_2, u8_2, u9_2, u10_2, u11_2, u12_2, u13_2, u14_2, u15_2, u16_2;
  ...
  for (int j = 0; j < nres_2; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  ...
		  &u10_2(j), &u11_2(j), &u12_2(j), &u13_2(j), &u14_2(j), &u15_2(j), &u16_2(j)) != 17)
	{
  ...
  EIreal_2.resize (nres_2); EIimag_2.resize (nres_2);
  EOreal_2.resize (nres_2); EOimag_2.resize (nres_2);
  ...
  for (int j = 0; j < nres_0; j++)
    {
      EIreal_0(j) = weight1 * EIreal_1(j) + weight2 * EIreal_2(j);
      EIimag_0(j) = weight1 * EIimag_1(j) + weight2 * EIimag_2(j); 
      EOreal_0(j) = weight1 * EOreal_1(j) + weight2 * EOreal_2(j); 
      EOimag_0(j) = weight1 * EOimag_1(j) + weight2 * EOimag_2(j); 
...
void Neoclassical::fFileInterpolateCubic (char* fFile1, double time1, char* fFile2, double time2, char* fFile3, double time3, char* fFile, double time)
{
  ...
  Array<int, 1>   mres_3;
  Array<double,1> u1_3, u2_3, u3_3, u4_3, u5_3, u6_3, u7_3, u8_3, u9_3, u10_3, u11_3, u12_3, u13_3, u14_3, u15_3, u16_3;
...
EOreal_1.resize (nres_1); EOimag_1.resize (nres_1);
  ...
  for (int j = 0; j < nres_3; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  ...
		  &u10_3(j), &u11_3(j), &u12_3(j), &u13_3(j), &u14_3(j), &u15_3(j), &u16_3(j)) != 17)
	{
  ...
  EIreal_3.resize (nres_3); EIimag_3.resize (nres_3);
  EOreal_3.resize (nres_3); EOimag_3.resize (nres_3);
					    ...
					    char* fFile4, double time4, char* fFile, double time)
{
  ...
  Array<int, 1>   mres_4;
  Array<double,1> u1_4, u2_4, u3_4, u4_4, u5_4, u6_4, u7_4, u8_4, u9_4, u10_4, u11_4, u12_4, u13_4, u14_4, u15_4, u16_4;
  ...
  for (int j = 0; j < nres_4; j++)
    {
      if (fscanf (file, "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",
		  ...
		  &u10_4(j), &u11_4(j), &u12_4(j), &u13_4(j), &u14_4(j), &u15_4(j), &u16_4(j)) != 17)
	{
  ...
  EIreal_4.resize (nres_4); EIimag_4.resize (nres_4);
  EOreal_4.resize (nres_4); EOimag_4.resize (nres_4);
  ...
  for (int j = 0; j < nres_0; j++)
    {
      EIreal_0(j) = weight1 * EIreal_1(j) + weight2 * EIreal_2(j) + weight3 * EIreal_3(j) + weight4 * EIreal_4(j);
      EIimag_0(j) = weight1 * EIimag_1(j) + weight2 * EIimag_2(j) + weight3 * EIimag_3(j) + weight4 * EIimag_4(j);
      EOreal_0(j) = weight1 * EOreal_1(j) + weight2 * EOreal_2(j) + weight3 * EOreal_3(j) + weight4 * EOreal_4(j);
      EOimag_0(j) = weight1 * EOimag_1(j) + weight2 * EOimag_2(j) + weight3 * EOimag_3(j) + weight4 * EOimag_4(j);
