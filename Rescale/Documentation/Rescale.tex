...
\title{\bf Rescaling of Plasma Equilibrium}
\date{\today}
...
Let
\begin{equation}
{\mit\Psi} = \frac{\psi - \psi_{\rm axis}}{\psi_{\rm separatrix}-\psi_{\rm axis}}.
\end{equation}
...
where
\begin{align}
q_{95} &\equiv q({\mit\Psi}=0.95),\\[0.5ex]
T_{95}&\equiv T({\mit\Psi}=0.95).
\end{align}
It follows that
\begin{align}
\psi_{\rm new} &= \psi_{\rm old},\\[0.5ex]
