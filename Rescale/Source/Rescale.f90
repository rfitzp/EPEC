...
program Rescale
  ...
  ! Read namelist file
  ! ..................
  call NameListRead (SCALE, q95_new, OPOINT, XPOINT)

  print *, 'SCALE = ', SCALE, 'Q95 = ', q95_new, 'OPOINT = ', OPOINT, 'XPOINT = ', XPOINT
  print *
...
subroutine NameListRead (SCALE, Q_95, OPOINT, XPOINT) 
  ...
  namelist /RESCALE_CONTROL/ SCALE, Q_95, OPOINT, XPOINT
