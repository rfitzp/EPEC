...
analysis is valid. 
Note, however, that the ion sound radius is finite even when the ions are cold. In the following, we shall assume that our model remains valid even when the ions are hot. 
...
exhibit an approximate $R^{-1}$ scaling). [In fact, it is easily demonstrated that if 
