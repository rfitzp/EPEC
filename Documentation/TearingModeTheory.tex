...
\begin{align}
v(T) &= \frac{\omega-\omega_E}{\omega_\ast},\\[0.5ex]
...
ion acoustic waves, whose dynamics are described by Equation~(\ref{e472}), have smoothed out
...
the forms of these  four flux-surface functions we need to solve the rescaled four-field model to higher order in our expansion. In particular,
...
\frac{d(\ln \hat{w}^{\,2})}{dT}\,\cos\zeta = \{F, {\mit\Omega}\} + \epsilon_\beta\,\epsilon_d\,\epsilon_\eta\,{\cal J}_0,
\end{equation}
where
\begin{equation}
F ({\mit\Omega},\zeta,T)= \epsilon_d^2\,({\mit\Phi}_2+\epsilon_d\,{\mit\Phi}_3)-\epsilon_d^{\,2}\left(\frac{\tau}{1+\tau}\right)({\cal N}_2+\epsilon_d\,{\cal N}_3)
...
\frac{\partial^2\psi}{\partial r^2}\,\sin\zeta\,\frac{d\zeta}{2\pi}\,dx\nonumber\\[0.5ex]&=-\frac{2}{\hat{w}\,\hat{R}_0\,\hat{\mit\Psi}_s}\int_{-\infty}^{\infty}\oint
...
\begin{align}
{\rm Im}\!\left(\frac{{\mit\Delta}\hat{\mit\Psi}_s}{\hat{\mit\Psi}_s}\right) &=\frac{4\,\epsilon_\beta\,\epsilon_d\,\epsilon_\chi}{\hat{w}}\int_0^\infty
...
\end{align}
where use has been made of the fact that $Y_i$ is continuous across the island separatrix. 
...
\int_1^\infty d_{\mit\Omega}(M\,Y_i)\left\langle\widetilde{X^2}\,\cos\zeta\right\rangle d{\mit\Omega}
...
\begin{equation}
{\rm Re}\!\left(\frac{{\mit\Delta}\hat{\mit\Psi}_s}{\hat{\mit\Psi}_s}\right)= I_1\,\tau_R\,\frac{d}{dt}\!\left(\frac{W}{r_s}\right)
+ I_2\left(\frac{\omega_\ast\,\tau_\varphi}{1+\tau}\right)\left(\frac{W}{r_s}\right)^2 {\rm Im}\!\left(\frac{{\mit\Delta}\hat{\mit\Psi}_s}{\hat{\mit\Psi}_s}\right),
\end{equation}
where
\begin{align}
I_1 &= 2\int_{-1}^\infty \frac{\langle \cos\zeta\rangle^2}{\langle 1\rangle}\,d{\mit\Omega},\\[0.5ex]
I_2 &= \frac{1}{32}\int_1^\infty d_{\mit\Omega}\!\left(\frac{F_i}{\langle X^2\rangle}\right)\left\langle\widetilde{X^2}\,\cos\zeta\right\rangle d{\mit\Omega}.
\end{align}
