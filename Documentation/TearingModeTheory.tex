...
V_{\theta\,i}(X,\zeta,T)& = -\frac{r_s\,\omega_\ast}{m}\,|X|\,Y_i({\mit\Omega},T),
\end{align}
where
\begin{align}
...
fluid velocity---and, hence, the function $Y_i$---is continuous across the separatrix, because the ion fluid possesses finite perpendicular viscosity. 
...
\end{equation}
which implies that zero electromagnetic torque is exerted at the resonant surface. (See Section~\ref{storque}.) 
Moreover, 
\begin{equation}
{\rm Re}\!\left(\frac{{\mit\Delta}\hat{\mit\Psi}_s}{\hat{\mit\Psi}_s}\right) = {\mit\Delta}_{pw}.
\end{equation}
Hence, Equations~(\ref{e456}), (\ref{e559}), and (\ref{e559}) yield the {\em Rutherford island width evolution equation}\/ (Rutherford 1973):
\begin{equation}
