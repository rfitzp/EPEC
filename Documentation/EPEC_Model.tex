...
{\mit\Delta}_{kw} &= -\frac{{\mit\Sigma}_{kw}^{\,2}}{{\mit\Delta}^{nw}_k-{\mit\Delta}^{pw}_k},\\[0.5ex]
...
\end{align}
Here, ${\cal I} = 0.8227$, $\epsilon_{100}=r_{100}/R_0$, $\hat{r}=r/r_{100}$, $\hat{r}_k=r_k/r_{100}$, $\hat{t}=t/\tau_A$, and $\rho(r)$ is the plasma
mass density profile.

The perturbed bootstrap current terms take the form
\begin{align}
