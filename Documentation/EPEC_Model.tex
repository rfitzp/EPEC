...
\hat{\rho}_{\theta\,e} &= \frac{2\,{\cal I}\,\rho_{\theta\,e}}{r}= \left(\frac{{\cal I}\,\rho_{\theta\,e}}{2\,r}\right)_{r_k}=\left(\frac{2\,{\cal I}\,v_{T\,e}\,m_e\,q\,R_0}{e\,B_0\,g\,r^{\,2}}\right)_{r_k},\\[0.5ex]
\hat{\rho}_{\theta\,i} &=  \frac{2\,{\cal I}\,\rho_{\theta\,i}}{r}= \left(\frac{{\cal I}\,\rho_{\theta\,i}}{2\,r}\right)_{r_k}= \left(\frac{2\,{\cal I}\,v_{T\,i}\,m_i\,q\,R_0}{e\,B_0\,g\,r^{\,2}}\right)_{r_k},\\[0.5ex]
...
\begin{equation}
\overline{W}_k = \left(\frac{d{\mit\Psi}_N}{dr}\right)_{r_k}\,W_k=4\left(A_{i\,k}\,\hat{\mit\Psi}_k\right)^{1/2},
\end{equation}
where 
\begin{equation}
...
However, the halfway point between the inner and outer extremities of the separatrix is located at the flux-surface where ${\mit\Psi}_N = {\mit\Psi}_N(r_k) - A_2{\,k}\,W_k^{\,2}/8$ and $A_{2\,k} = [(1/3)\,(d^{\,2}q/d{\mit\Psi}_N^{\,2})/(dq/d{\mit\Psi}_N)]_{r_k}$.
...
\nonumber\\[0.5ex]
&\phantom{++}+\left[\delta_{T_e\,k}\,n_e\,\frac{dT_e}{d{\mit\Psi}_N}- \delta_{T_e\,k}\,\overline{W}_k^{\,2}\,\frac{A_{2\,k}}{8}\left(\frac{dn_e}{d{\mit\Psi}_N}\,\frac{dT_e}{d{\mit\Psi}_N}+
 n_e\,\frac{d^{\,2}T_e}{d{\mit\Psi}_n^{\,2}}\right)
+ \delta_{T_e\,k}^{\,3}\,\frac{n_e}{24}\,\frac{d^{\,3}T_e}{d{\mit\Psi}_N^{\,3}}\right]\nonumber\\[0.5ex]
&\phantom{++}+\left[\delta_{n_e\,k}\,\frac{dn_i}{d{\mit\Psi}_N}\,T_i- \delta_{n_e\,k}\,\overline{W}_k^{\,2}\,\frac{A_{2\,k}}{8}\left(\frac{dn_i}{d{\mit\Psi}_N}\,\frac{dT_i}{d{\mit\Psi}_N}+\frac{d^{\,2}n_i}{d{\mit\Psi}_n^{\,2}}
\,T_i\right)+ \delta_{n_e\,k}^{\,3}\,\frac{d^{\,3}n_i}{d{\mit\Psi}_N^{\,3}}\,\frac{T_i}{24}\right]
\nonumber\\[0.5ex]
&\phantom{++}\left.+\left[\delta_{T_i\,k}\,n_i\,\frac{dT_i}{d{\mit\Psi}_N}- \delta_{T_i\,k}\,\overline{W}_k^{\,2}\,\frac{A_{2\,k}}{8}\left(\frac{dn_i}{d{\mit\Psi}_N}\,\frac{dT_i}{d{\mit\Psi}_N}+n_i\,\frac{d^{\,2}T_i}{d{\mit\Psi}_n^{\,2}}\right)
